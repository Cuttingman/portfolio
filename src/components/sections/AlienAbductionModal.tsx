...
export const alienAbductionGalleryImages: GalleryImageDef[] = [
  { src: "/image/우수상장-창업발전소_콘텐츠_스타트업_리그_공모전.jpg", alt: "2018 창업발전소 우수상" },
  { src: "/image/피그플랜트_시연_사진3.jpg", alt: "피그플랜트 게임 시연 1" },
  { src: "/image/피그플랜트_시연_사진4.jpg", alt: "피그플랜트 게임 시연 2" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24 items-start">
          <div className="lg:col-span-4 flex flex-col gap-6 sticky top-24">
            ...
            <ul className="list-none p-0 space-y-4 font-medium text-gray-300 text-base mt-4 border-l-2 border-white/20 pl-6">
              <li className="m-0">
                ...
                자체 IP 제작, 모바일 게임 제작, AR 그림책 제작 및 경영
              </li>
              <li className="m-0">
          ...
          <div className="lg:col-span-8 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-6 p-8 bg-white/5 rounded-3xl border border-white/10 shadow-lg hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 mb-12">
              ...
              <div className="mt-4 border-t border-white/10 pt-6">
                <p className="font-medium leading-relaxed text-gray-300 m-0 text-sm">
                  피그플랜트는 AR 게임으로 식물들을 키워서 식량을 얻고 돼지들에게 식량을 제공하는 게임이다.<br/>
                  식물을 성장시키기 위해서는 햇빛과 물이 필요하다. 햇빛과 물은 유저가 위치한 장소의 실제 날씨를 받아와서 게임속에서 구현된다.<br/>
                  실제 날씨를 게임에 반영하므로 날씨가 변함에 따라 게임속 식물들을 관리해야 한다.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-white/90 border border-white/10 hover:shadow-xl transition-shadow">
                   <GalleryImageTrigger
                     src="/image/우수상장-창업발전소_콘텐츠_스타트업_리그_공모전.jpg"
                     alt="2018 창업발전소 우수상"
                     index={0}
                ...
                <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-black/50 border border-white/10 hover:shadow-xl transition-shadow">
                   <GalleryImageTrigger
                     src="/image/피그플랜트_시연_사진3.jpg"
                     alt="피그플랜트 게임 시연 1"
                     index={1}
                     imgClassName="w-full h-full object-cover m-0"
                     className="block w-full h-full"
                ...
                <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-black/50 border border-white/10 hover:shadow-xl transition-shadow">
                   <GalleryImageTrigger
                     src="/image/피그플랜트_시연_사진4.jpg"
                     alt="피그플랜트 게임 시연 2"
                     index={2}
                     imgClassName="w-full h-full object-cover m-0"
                     className="block w-full h-full"
            ...
            <div className="flex flex-col gap-8 mb-16">
              ...
              <div className="flex flex-col gap-4 p-8 bg-white/5 rounded-3xl border border-white/10 shadow-lg hover:-translate-y-2 hover:shadow-2xl transition-all duration-500">
                <h5 className="text-xl font-bold font-sans text-white m-0">스토리</h5>
                <p className="font-medium leading-relaxed text-gray-400 m-0 text-sm">
                  소시지 공장에 들어간 암퇘지는 외마디 비명과 함께 밤하늘의 별이 되고, 이 상황을 목격한 수퇘지는 암퇘지를 찾아 밤하늘로 모험을 떠난다.
                </p>
              </div>
            </div>
