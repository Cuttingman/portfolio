...
export const activitiesGalleryImages: GalleryImageDef[] = [
  ...
  { src: "/image/typo_class_3.jpg", alt: "타이포그래피 교육 현장 1" },
  { src: "/image/typo_class_2.jpg", alt: "타이포그래피 교육 현장 2" },

  // Item 12: Tumblbug Prototype (1 image) 13
  { src: "/image/goods_tumblbug.png", alt: "피그로맨스 완구 텀블벅 아이템" },
];
        ...
        <div className="space-y-8">
          ...
          <div className="w-full max-w-xl mx-auto">
            <GalleryImageTrigger
              ...
              imgClassName="w-full h-full object-cover object-[center_35%] rounded-3xl"
            />
          </div>
        </div>
            ...
            <div className="flex flex-col gap-8 items-start bg-[#111] p-8 rounded-3xl border border-white/5">
              <div className="w-full">
                ...
                <GalleryImageTrigger
                  ...
                  onClick={setGalleryIndex}
                  className="aspect-[21/9] md:aspect-[3/1] w-full block max-w-xl mx-auto max-h-60"
                  imgClassName="w-full h-full object-cover object-[center_35%] rounded-2xl"
                />
              </div>
            </div>
