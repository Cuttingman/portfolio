  ...
  return (
    <div className="prose prose-lg dark:prose-invert max-w-7xl mx-auto w-full">
      ...
      <div className="mb-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center justify-items-center opacity-90 p-8 bg-[#111] rounded-3xl border border-white/5">
        <div className="w-32 h-32 md:w-40 md:h-40 relative"><img src="/image/초기게임개발사.png" alt="초기게임개발사 1위" className="w-full h-full object-contain filter drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:scale-110 transition-transform" /></div>
      ...
      <div className="space-y-24">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 aspect-video bg-black/50 rounded-3xl overflow-hidden border border-white/5 relative">
            ...
            <div>
              <GalleryImageTrigger src={awardsGalleryImages[0].src} alt={awardsGalleryImages[0].alt} index={0} onClick={setGalleryIndex} className="aspect-[3/4] md:h-full block w-full" imgClassName="w-full h-full object-cover object-top rounded-3xl" />
            </div>
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-gray-800 space-y-6">
          ...
          <div>
             <GalleryImageTrigger src={awardsGalleryImages[10].src} alt={awardsGalleryImages[10].alt} index={10} onClick={setGalleryIndex} className="aspect-video block w-full" imgClassName="w-full h-full object-cover rounded-3xl" />
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-gray-800 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="md:col-span-2">
               <GalleryImageTrigger src={awardsGalleryImages[4].src} alt={awardsGalleryImages[4].alt} index={4} onClick={setGalleryIndex} className="aspect-video block w-full" imgClassName="w-full h-full object-cover rounded-3xl" />
             </div>
             <div>
               <GalleryImageTrigger src={awardsGalleryImages[5].src} alt={awardsGalleryImages[5].alt} index={5} onClick={setGalleryIndex} className="h-full block w-full" imgClassName="w-full h-full object-cover rounded-3xl" />
             </div>
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-gray-800 space-y-6">
          ...
          <div className="w-full lg:w-2/3">
             <GalleryImageTrigger src={awardsGalleryImages[6].src} alt={awardsGalleryImages[6].alt} index={6} onClick={setGalleryIndex} className="aspect-video block w-full" imgClassName="w-full h-full object-cover rounded-3xl" />
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-gray-800 space-y-6">
          ...
          <div>
             <GalleryImageTrigger src={awardsGalleryImages[11].src} alt={awardsGalleryImages[11].alt} index={11} onClick={setGalleryIndex} className="aspect-video block w-full" imgClassName="w-full h-full object-cover rounded-3xl" />
          </div>
        </div>
        ...
        <div className="pt-16 border-t border-gray-800 space-y-6">
          ...
          <div className="w-full sm:w-2/3 md:w-1/2">
             <GalleryImageTrigger src={awardsGalleryImages[12].src} alt={awardsGalleryImages[12].alt} index={12} onClick={setGalleryIndex} className="aspect-[3/4]" imgClassName="w-full h-full object-cover rounded-3xl" />
          </div>
        </div>
