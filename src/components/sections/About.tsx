              ...
              <AnimatePresence mode="wait">
                ...
                {activeTab === "bio" && (
                  ...
                  >
                    ...
                    <p className="mb-4 text-white">
                      계원예술대학교에서 인지학 기반 디자인을 공부한 뒤, 디자인 스튜디오 토이랩을 창업해 전시 그래픽, 영상, 애니메이션, 브랜드 디자인 등 실무 전반을 수행했습니다. 이후 독자 IP를 만들겠다는 목표로 게임 스튜디오 외계인납치작전을 설립하고, 내러티브 퍼즐 플랫포머 게임<br />
                      피그로맨스를 제작했습니다.
                    </p>
                    <p className="mb-4 text-white">
                    ...
                    <p className="mb-4 text-white">
                      생성형 AI를 활용한 이미지 및 영상 제작을 실무에 적용하고 있으며, 이를 팀 단위 프로세스로 정착시키는 방법론을 설계하고 있습니다.
                    </p>
