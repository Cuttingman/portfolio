                ...
                {activeTab === "bio" && (
                  ...
                  >
                    <p className="mb-4 text-white">
                      그래피티 작가에서 상업 디자인, 게임 개발 등 시각 콘텐츠 제작 분야에서 모든 과정을 설계하고 이끌어 왔습니다.
                    </p>
                    <p className="mb-4 text-white">
                      주요 경력으로는 '계원예술대학교'에서 인지학 기반 디자인을 공부한 뒤, 디자인 스튜디오 '토이랩'을 창업해 전시 그래픽, 영상, 애니메이션, 브랜드 디자인 등 실무 전반을 수행했고, 이후 독자 IP를 만들겠다는 목표로 게임 스튜디오 '외계인납치작전'을 설립하고, 내러티브 퍼즐 플랫포머 게임 '피그로맨스'를 총괄 개발했습니다.
                    </p>
                    <p className="mb-4 text-white">
