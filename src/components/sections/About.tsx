...
export function AboutSection() {
  ...
  return (
    <section id="about" className="bg-black text-white transition-colors duration-1000 w-full">
      <div className="container mx-auto px-12 md:px-24 pt-32 pb-48 min-h-screen scroll-mt-24 mb-24">
      <motion.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
        ...
        <motion.div
          ...
          className="lg:col-span-5 aspect-[3/4] bg-foreground/5 relative overflow-hidden flex items-center justify-center text-foreground/20 font-medium rounded-3xl shadow-lg hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(255,255,255,0.1)] transition-all duration-500"
        >
          <img src="/image/gls2022_2_03_076_.png" alt="Profile" className="w-full h-full object-cover" />
        ...
        >
          <div className="flex gap-8 mb-12 border-b border-white/10 pb-4">
            {tabs.map((tab) => (
              <button
                ...
                className={`text-2xl md:text-4xl font-black tracking-tight transition-colors duration-300 ${
            ...
            <AnimatePresence mode="wait">
              {activeTab === "profile" && (
                ...
                <ul className="space-y-4">
                  <div className="flex flex-col gap-6 w-full">
                    ...
                    <li className="flex flex-col border-b border-white/10 pb-4">
                      <div className="flex flex-wrap gap-8 items-center pt-1">
                        <a href="https://www.facebook.com/PIGROMANCE" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
                          <Facebook size={22} />
                          <span className="text-lg font-medium">Facebook</span>
                        </a>
                        <a href="https://www.youtube.com/@oreamack" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
                          <Youtube size={22} />
                  ...
                  {/* Links */}
                  <div className="flex flex-col gap-4 pt-8 border-t border-foreground/5">
                    <a href="https://gemini.google.com/share/62f619990e7f" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-4 bg-foreground/5 hover:bg-foreground/10 text-foreground rounded-sm transition-colors text-base font-bold w-fit">
                      Gemini 인재 분석 보고서
                      <ExternalLink size={16} className="opacity-50" />
                    </a>
                    
                    <a href="https://drive.google.com/drive/folders/17OaEjVESIN7DfhuleC7V2HHfZPtUL55V?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-4 bg-white text-black hover:opacity-90 rounded-sm transition-opacity text-base font-bold w-fit">
                      피그로맨스 게임 다운로드
                    </a>
                  </div>
                </motion.div>
          ...
          >
            <div className="pt-16 mt-16 border-t border-white/10">
                <h3 className="text-sm font-black tracking-widest text-white/40 uppercase mb-8">Capabilities</h3>
