              ...
              <AnimatePresence mode="wait">
                ...
                {activeTab === "bio" && (
                  ...
                  >
                    ...
                    <p className="mb-4 text-white">
                      시나리오부터 아트 디렉션, 애니메이션, 사운드 디렉팅까지 제작 전 과정을 이끌었으며, 스팀 98% 긍정 평가, 국내 주요 게임 어워즈 다수 수상, 메이저 게임사와의 글로벌 퍼블리싱 계약 체결 및 닌텐도 스위치 포팅을 완수했습니다.<br />
                      또한 게임스컴, TGS 등 해외 전시와 IR, 정부 지원사업까지 사업 운영 전반을 직접 수행했습니다.
                    </p>
                    <p className="mb-4 text-white">
                      최근에는 AI로 만든 리소스를 실무에 쓸 수 있는 수준으로 끌어올리는 작업을 하고 있으며, 이를 팀 단위 프로세스로 정착시키는 방법론을 설계 중입니다.
                    </p>
